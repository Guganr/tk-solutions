            ...
            <form method="post" action="{{ route('pagamentos.store') }}">
               ...
               <div class="shadow overflow-hidden sm:rounded-md">
                  <div class="px-4 py-5 bg-white sm:p-6">
                        <label for="datas_pagamento" class="block font-medium text-sm text-gray-700">Datas</label>
                  ...
                  <div class="px-4 py-5 bg-white sm:p-6">
                     <label for="valor" class="block font-medium text-sm text-gray-700">Valor do pagamento
                     </label>
